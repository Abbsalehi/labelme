...
###################################################################################################################
    def _get_segmentation_from_boxes(
        ...
        # Initialize SAM model using correct osam API
        try:
            # Get model class and initialize it
            ModelClass = osam.apis.get_model_type_by_name(sam_model_name)
            sam_model = ModelClass()
